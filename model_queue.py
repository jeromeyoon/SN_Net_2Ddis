...
class DCGAN(object):
	...
	# generated surface normal
        ...
        self.gen_loss = (1-self.lambda_) * self.g_loss + self.L_loss * self.lambda_+self.ang_loss
	...
	if self.use_queue:
		...
		for idx in xrange(0,batch_idxs):
		     ...
		     print("Epoch: [%2d] [%4d/%4d] time: %4.4f g_loss: %.6f L_loss:%.4f ang_loss:%.4f" \
		     % (epoch, idx, batch_idxs,time.time() - start_time,g_loss,L_loss,ang_loss))
		     sum_L += L_loss 
		     sum_ang += ang_loss	
		     sum_g += g_loss
